...
import { experienceData, experienceIcons } from '../data/experienceData';

const Experience = () => {
  return (
    <section id="experience" className="w-full px-6 py-16 md:py-24 select-none overflow-hidden bg-[#ffffff]">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-1">
                    <div className="flex flex-col gap-2 [&_svg]:transition-colors [&_svg]:duration-500 [&_svg]:shrink-0">
                      <h3 className="font-chillax lg:text-xl font-black tracking-tight text-stone-900 flex items-center gap-1.5">
                        <experienceIcons.role className="group-hover:text-[#afafaf]"/>{item.role}
                      </h3>
                      <p className="font-satoshi text-xs lg:text-sm font-medium text-stone-900 flex items-center gap-1.5">
                        <experienceIcons.calendar className="group-hover:text-[#1e63ca]" /> {item.duration} 
                      </p>
                      <p className="font-satoshi text-xs lg:text-sm font-medium text-stone-900 flex items-center gap-1.5">
                        <experienceIcons.company className="group-hover:text-[#c71717]" /> {item.organization} 
                      </p>
                      <p className="font-satoshi text-xs lg:text-sm text-stone-900 flex items-center gap-1.5 italic">
                        <experienceIcons.growth className="group-hover:text-[#209b3e]" />{item.summary}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-1 font-satoshi text-xs lg:text-sm text-stone-900 leading-relaxed pt-1">
                    {item.contributions.map((contribution) => (
                      <div key={contribution.id} className="flex justify-start gap-1">
                        <experienceIcons.arrow className="text-lg lg:text-xl shrink-0 select-none"/>
