  ...
  return (
    <section id="projects" className="w-full px-6 py-36 select-none overflow-hidden bg-[#ffffff]">
      <div className="w-full max-w-6xl mx-auto flex flex-col gap-8 md:gap-12">
              ...
              <div className="flex flex-col gap-4 overflow-hidden rounded-2xl border border-stone-200 
                ...
                <div className="flex flex-col gap-5 pt-4 px-6 sm:pt-8 sm:px-8">
                  ...
                  <div className="flex flex-row justify-between gap-4">
                    ...
                    <div className="flex flex-row justify-end gap-8 font-chillax text-xs lg:text-sm">
                      {project.demoUrl && (
                  ...
                  <div className="flex flex-row justify-between items-start gap-4">
                    <p className="font-satoshi text-xs lg:text-sm font-black text-stone-500">
                      {project.type}
                    </p>
                  ...
                  <p className="font-satoshi font-black text-xs lg:text-sm text-justify leading-relaxed text-stone-500">
                    {project.description}
                  </p>          
                </div>
        ...
        <div className="flex justify-center font-chillax text-sm text-neutral-500">
